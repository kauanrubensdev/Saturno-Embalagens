      ...
      <div className="min-h-screen" style={{ backgroundColor: '#fcfbf8' }}>
        ...
        <div className="max-w-5xl mx-auto px-4 py-8">
          <div className="animate-pulse">
            <div className="h-8 w-48 rounded mb-8" style={{ backgroundColor: '#e5e5e5' }} />
            <div className="space-y-4">
              {[1, 2, 3].map((i) => (
                <div key={i} className="flex gap-4 p-4 rounded-xl" style={{ backgroundColor: '#ffffff', border: '1px solid #e5e5e5' }}>
                  <div className="w-20 h-20 rounded-lg" style={{ backgroundColor: '#e5e5e5' }} />
                  <div className="flex-1 space-y-2">
                    <div className="h-4 w-3/4 rounded" style={{ backgroundColor: '#e5e5e5' }} />
                    <div className="h-3 w-1/4 rounded" style={{ backgroundColor: '#e5e5e5' }} />
                  </div>
                </div>
              ))}
            </div>
    ...
    <div className="min-h-screen" style={{ backgroundColor: '#fcfbf8' }}>
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <nav className="flex items-center gap-2 text-sm mb-6" style={{ color: '#999999' }}>
          <Link to="/" className="no-underline transition-colors hover:opacity-80" style={{ color: '#999999' }}>
            Início
          </Link>
          <span>/</span>
          <span style={{ color: '#1a1a1a' }}>Carrinho</span>
        </nav>

        <h1 className="text-2xl md:text-3xl font-bold mb-6" style={{ color: '#1a1a1a' }}>
          Carrinho de compras
        </h1>
