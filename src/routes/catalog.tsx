  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#fcfbf8' }}>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        {/* Page Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-2" style={{ color: '#1a1a1a' }}>Catálogo</h1>
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            <div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4" style={{ backgroundColor: '#fff7ed' }}>
              <svg className="w-6 h-6" style={{ color: '#FF6B00' }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
              </svg>
            </div>
      ...
      <footer className="border-t mt-12" style={{ backgroundColor: '#ffffff', borderColor: '#e5e5e5' }}>
        <div className="max-w-7xl mx-auto px-4 py-8 text-center">
          <Link to="/" className="inline-flex items-center gap-2 no-underline mb-2">
            ...
            <span className="font-bold text-sm" style={{ color: '#1a1a1a' }}>SaturnoEmbalagens</span>
          </Link>
