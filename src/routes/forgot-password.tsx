    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ backgroundColor: '#fcfbf8' }}>
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold" style={{ color: '#1a1a1a' }}>Recuperar senha</h1>
          <p className="mt-1 text-sm" style={{ color: '#666666' }}>Enviaremos um link para redefinir sua senha</p>
        </div>
        ...
        <div className="rounded-2xl shadow-lg p-8" style={{ backgroundColor: '#ffffff', border: '1px solid #e5e5e5' }}>
          {success ? (
            <div className="text-center py-6">
              ...
              <h3 className="text-lg font-semibold mb-2" style={{ color: '#1a1a1a' }}>E-mail enviado!</h3>
